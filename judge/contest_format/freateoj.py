...
@register_contest_format('freateoj')
class FreateOJContestFormat(DefaultContestFormat):
    name = gettext_lazy('FreateOJ')
    ...
    def validate(cls, config):
        ...
        if not isinstance(config, dict):
            raise ValidationError('FreateOJ-styled contest expects no config or dict as config')
