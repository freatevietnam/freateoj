...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.IntegerField(default=0, help_text='If set, the scoreboard will be frozen for the last X minutes. Only available for ICPC and FreateOJ format.', verbose_name='frozen last minutes'),
        ),
        migrations.AddField(
