...
from judge.views.user import AddUserCSV, AddUserGUI, SampleCSVDownload, UserComparisonView
...
urlpatterns = [
    ...
    path('users/', include([
        ...
        path('compare/', UserComparisonView.as_view(), name='user_compare'),
        path('add/', AddUserGUI.as_view(), name='add_user'),
        path('import/', AddUserCSV.as_view(), name='import_users'),
        path('import/sample-csv/', SampleCSVDownload.as_view(), name='sample_csv'),
    ...
    path('relationship/', include([
        ...
        path('accept-type-change/<int:relationship_id>/', relationship_views.accept_type_change, name='relationship_accept_type_change'),
        path('reject-type-change/<int:relationship_id>/', relationship_views.reject_type_change, name='relationship_reject_type_change'),
    ])),
    ...
    path('judge-select2/', include([
        ...
        path('problem/public/', PublicProblemSelect2View.as_view(), name='problem_select2_public'),
        path('problem/org/<int:org_pk>/', OrganizationProblemSelect2View.as_view(), name='problem_select2_org'),
...
if settings.FREATEOJ_ENABLE_SYNC_API:
    urlpatterns.append(
